-- Migration: Update flatten_profile_data function to handle label field
-- This updates the function to accept and return label data from public_profiles

CREATE OR REPLACE FUNCTION flatten_profile_data(profile_json JSONB, source_original_id TEXT, source_label TEXT DEFAULT NULL)
RETURNS TABLE (
    original_id TEXT,
    full_name TEXT,
    current_title TEXT,
...
BEGIN
    ...
    label := source_label; -- Add label assignment
